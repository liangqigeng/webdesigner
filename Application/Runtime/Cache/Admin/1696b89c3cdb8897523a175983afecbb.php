            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>单页管理</h5>
                        <small><a href="<?php echo U('page_list');?>" style="color:#ccc;margin-left:10px"><i class="fa fa-list"></i>单页列表</a></small>
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="page_content"><?php echo ($page["page_content"]); ?></textarea>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">

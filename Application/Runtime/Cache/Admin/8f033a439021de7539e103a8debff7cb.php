            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>导航管理</h5>
                        <small><a href="<?php echo U('nav_list');?>" style="color:#ccc;margin-left:10px"><i class="fa fa-list"></i>导航列表</a></small>
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="nav_name">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="nav_url">
                                </div>
                            </div>
                              <div class="hr-line-dashed"></div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="nav_ord">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">

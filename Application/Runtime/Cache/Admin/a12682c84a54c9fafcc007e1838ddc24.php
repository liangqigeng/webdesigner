            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>管理员信息</h5>
                        <small><a href="<?php echo U('admin_list');?>" style="color:#ccc;margin-left:10px"><i class="fa fa-list"></i>管理员列表</a></small>
                        ...
                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="hr-line-dashed"></div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="admin_info">
                                </div>
                            </div>
                             <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">头像</label>
                                    <input type="file" name="admin_photo" id="upload"/>
                             ...
                             <div class="form-group">
                                ...
                                <label>
                                    <input type="radio" checked="" value="1" id="optionsRadios1" name="admin_sex">男</label>
                                 <label>
                                <input type="radio" value="2" id="optionsRadios2" name="admin_sex">女</label>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">

            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>文章分类信息</h5>
                        <small><a href="<?php echo U('cat_art_list');?>" style="color:#ccc;margin-left:10px"><i class="fa fa-list"></i>文章分类列表</a></small>
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="cat_name" value="<?php echo ($cat['cat_name']); ?>">
                                </div>
                            </div>
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="cat_ord" value="<?php echo ($cat['cat_ord']); ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" readonly="true" class="form-control  layer-date" id="date" name="cat_addtime" value="<?php echo (date('Y-m-d',$cat['cat_addtime'])); ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">

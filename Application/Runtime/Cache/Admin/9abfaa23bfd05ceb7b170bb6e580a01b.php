            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>文章信息</h5>
                        <small><a href="<?php echo U('article_list');?>" style="color:#ccc;margin-left:10px"><i class="fa fa-list"></i>文章列表</a></small>
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="art_title" value="<?php echo ($article['art_title']); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="art_summary" value="<?php echo ($article['art_summary']); ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <label>
                                    <input type="radio" value="1" id="optionsRadios1" name="is_show" <?php echo ($article['is_show']==1?'checked':''); ?>>是</label>
                                 <label>
                                <input type="radio" value="0" id="optionsRadios2" name="is_show" <?php echo ($article['is_show']==0?'checked':''); ?>>否</label>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" readonly="true" class="form-control  layer-date" id="date" name="art_addtime" value="<?php echo (date('Y-m-d',$article['art_addtime'])); ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">文章内容</label>
                                <textarea name="art_content"><?php echo ($article['art_content']); ?></textarea>
                            </div>
                             <div class="form-group">
                                <label class="col-sm-2 control-label">文章排序</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="art_ord" value="<?php echo ($article['art_ord']); ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">文章图片</label>
                                 <input type="file" name="art_img" value="" class="form-control" id="upload">
                                  ...
                                  <?php if($article['art_img']): ?><img src="/Upload//<?php echo ($article['art_img']); ?>" alt="" id="img">
                                   <?php else: ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                   <select class="form-control" name="cat_id">
                                       ...
                                       <?php if(is_array($cat)): foreach($cat as $key=>$v): ?><option value="<?php echo ($v["cat_id"]); ?>"
                                          <?php if(($article['cat_id']) == $v['cat_id']): ?>selected<?php endif; ?>>
                                              <?php echo ($v["cat_name"]); ?>

                        ...
                        <form method="post" class="form-horizontal" enctype="multipart/form-data" id="myform">
                            <input type="hidden" name="banner_id" value="<?php echo ($banner["banner_id"]); ?>">
                             <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="banner_title" value="<?php echo ($banner["banner_title"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="banner_url"  value="<?php echo ($banner["banner_url"]); ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">文章图片</label>
                                 <input type="file" name="banner_path" value="" class="form-control" id="upload">
                                  ...
                                  <?php if($banner['banner_path']): ?><img src="/Upload/<?php echo ($banner['banner_path']); ?>" alt="" id="img">
                                   <?php else: ?>
                                        <img src="/Public/Admin/img/images.png" alt="" id="img"><?php endif; ?>
                                  </label>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">

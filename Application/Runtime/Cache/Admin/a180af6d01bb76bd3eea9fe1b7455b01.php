                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo U('Nav/nav_add');?>" class="btn btn-primary btn-xs">添加导航</a>
                        </div>
                    </div>
                        ...
                        <div class="row m-b-sm m-t-sm">
                            ...
                            <div class="col-md-11">
                                <div class="input-group" style="width: 80%;float: right">
                                    <input type="text" placeholder="请输入导航名称" class="input-sm form-control"> <span class="input-group-btn">
                            ...
                            <table class="table table-hover" style="text-align:center">
                                <tbody>
                                  <tr>
                                      ...
                                      <th><i class="fa fa-tag"></i>导航名称</th>
                                      <th><i class="fa fa-underline"></i>导航地址</th>
                                      <th><i class="fa fa-sort-numeric-asc"></i>导航排序</th>
                                      <th><i class="fa fa-hand-o-down"></i>操作</th>
                                  </tr>
                                  <?php if(is_array($nav)): foreach($nav as $key=>$v): ?><tr>
                                        <td><?php echo ($a++); ?></td>
                                        <td><?php echo ($v["nav_name"]); ?></td>
                                        <td><?php echo ($v["nav_url"]); ?></td>
                                        <td><?php echo ($v["nav_ord"]); ?></td>
                                        <td>
                                            <a href="<?php echo U('Admin/Nav/nav_edit/nav_id/'.$v['nav_id']);?>" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>
                                            <a href="javascript:void(0)" class="btn btn-white btn-sm del" del_id="<?php echo ($v["nav_id"]); ?>"><i class="fa fa-trash"></i> 删除 </a>
                                        </td>

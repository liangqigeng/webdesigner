                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal">
                           <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="nav_name" value="<?php echo ($nav["nav_name"]); ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="nav_url" value="<?php echo ($nav["nav_url"]); ?>">
                                </div>
                            </div>
                              <div class="hr-line-dashed"></div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="nav_ord" value="<?php echo ($nav["nav_ord"]); ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">

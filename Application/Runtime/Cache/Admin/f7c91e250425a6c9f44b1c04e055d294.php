                        ...
                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                            <div class="form-group">
                               ...
                               <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="tag_name"  value="<?php echo ($tag["tag_name"]); ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">标签地址</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="tag_url"  value="<?php echo ($tag["tag_url"]); ?>">
                                </div>
                            </div>
                             <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">标签排序</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="tag_ord" value="<?php echo ($tag["tag_ord"]); ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">

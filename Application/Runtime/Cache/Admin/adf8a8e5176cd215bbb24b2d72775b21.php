                    ...
                    <div class="ibox-content">
                        <form method="get" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <label>
                                    <input type="radio" checked="" value="1" id="optionsRadios1" name="optionsRadios">是</label>
                                 <label>
                                <input type="radio" value="0" id="optionsRadios2" name="optionsRadios">否</label>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" readonly="true" class="form-control  layer-date" id="date">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                   <select class="form-control" name="art_cate">
                                       <option>公司新闻</option>
                                       <option>公司历史</option>
                                       <option>企业文化</option>
                                       <option>关于我们</option>
